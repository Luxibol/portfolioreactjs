...
function Footer() {
    return (
        <footer className="bg-dark text-light text-lg-start">
            <Container className="py-3 px-4 px-md-0">
                <Row>
                    {/* Première colonne */}
                    <Col sm={12} md={4} className="mb-4 mb-md-0">
                        ...
                        <div className="d-flex mt-3"> 
                            ...
                            */}
                            <a href="https://github.com/github-john-doe" target="_blank" rel="noopener noreferrer nofollow" className="text-secondary mx-2" id="icone-footer">
                            <FaGithub size={24} />
                            </a>
                            <a href="https://github.com/github-john-doe" target="_blank" rel="noopener noreferrer nofollow" className="text-secondary mx-2" id="icone-footer">
                            <FaTwitter size={24} />
